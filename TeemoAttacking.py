...
'''
#############################################################
# My solution (Fastest as at 26-Sep-2020)
...
def findPoisonedDuration(timeSeries, duration):
    ...
    for t in timeSeries:
        ...
        if t > poisoned_end:
            ...
            if temp > poisoned_end:
                poisoned = poisoned + (temp - poisoned_end)
                poisoned_end = temp
